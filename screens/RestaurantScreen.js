...
const RestaurantScreen = () => {
    ...
    /*
        to accept parameters from with route navigation
        we use useRoute hook.
        so below we are destructuring to get parameters exectly
        we need. 
    */
    const {
        params: {
    ...
    return ( 
        ...
        <ScrollView>
            ...
            <Text className="px-4 pt-4 mb-3 text-2xl font-bold">Menu</Text>
            {/* dishes */}
